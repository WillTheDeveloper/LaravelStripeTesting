        ...
        <section aria-labelledby="order-heading" class="mt-10 border-t border-gray-200">
            ...
            <div class="flex py-10 space-x-6 border-b border-gray-200">
                <img src="https://tailwindui.com/img/ecommerce-images/confirmation-page-05-product-01.jpg"
                     ...
                     class="object-cover object-center flex-none w-20 h-20 bg-gray-100 rounded-lg sm:w-40 sm:h-40">
                <div class="flex flex-col flex-auto">
                    ...
                    <div class="flex flex-1 items-end mt-6">
            ...
            <div class="sm:ml-40 sm:pl-6">
                ...
                <dl class="grid grid-cols-2 gap-x-6 py-10 text-sm border-t border-gray-200">
                    <div>
